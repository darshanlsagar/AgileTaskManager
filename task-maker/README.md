...
Aim of the project is to achive a agile task maker and manger for daily standup meetings.

Presently some default task has been added for testing in sampleTasks.json of src folder.


Developer guide - 

Task propTypes is as follows
{
  complexity:easy,medium,difficult
  status:wip,completed,hold,new
  startDate:
  endDate:
  key:
  title:
...
Dynamically added contents are yet to be saved through a rest service.
